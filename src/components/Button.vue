<template>
  <!-- Na condicional da classe, se o button tiver a propriedade double, será aplicada a classe CSS double.
  O mesmo ocorre para os outros parâmetros-->
  <!-- O $emit() é utilizado para emitirmos um evento personalizado -->
